...
import {Container, Left, Right, Header, Button, Icon, Body, Title} from 'native-base'
...
class LoginKeychainScreen extends Component {
    state = {
        username: '',
        password: '',
        status: '',
        ...
        return (
                ...
                <Header style={styles.form_body}>
                    ...
                    <Body style={styles.form_body_header}>
                        <Title style={styles.form_title}>Login KeyChain</Title>
                    </Body>
                    <Right />
                </Header>
            ...
            >
                <View style={styles.content}>
                    <Text style={styles.title}>Keychain</Text>
...
export default LoginKeychainScreen;
